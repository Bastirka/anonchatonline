...
Repozitorijā ir arī `api/index.mjs` un `vercel.json`. Tie eksportē HTTP/Socket.IO serveri kā Vercel Function un novirza `/socket.io/*` un `/health` pieprasījumus uz šo funkciju. Sākumlapa un citi `public/` faili tiek pasniegti no Vercel CDN.
